        ...
        try:
            ...
            if "volume" in df.columns:
                def parse_vol(v):
                    ...
                    s = str(v).replace("\u00a0", "").replace("\u202f", "").replace(" ", "").lower()
                    mult = 1
            ...
            # ➜ Mémoriser pour l’onglet 3
            st.session_state["tech_score"] = float(score_tech)
